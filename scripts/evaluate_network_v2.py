...
def fold(train,cal,test,name):
    ...
    for method,score in scores.items():
        ...
        threshold=threshold_from_negatives(c,.05)
        result['models'][method]['calibrated_fpr_0.05']={'threshold':threshold,'metrics':metrics(ey,s,threshold)}
    return result
...
def main():
    ...
    a=ap.parse_args()
    old=legacy_rows(); new=new_rows(a.root)
